...
class Player {
    ...
    func renderSearch() -> Void {
        ...
        Console.printXY(1,24,"Results Found: \(self.searchResult.count)",80, .center, " ", ConsoleColor.black, ConsoleColorModifier.none, ConsoleColor.white, ConsoleColorModifier.bold)
    }
